  ...
  <form>
    <div id="container">
      ...
      <div class="side-by-side clearfix">
        <div>
          <em>Turns This</em>
          <select data-placeholder="Choose Normal Select Country..." class="select" tabindex="1">
          <option value="">Normal Select</option>
            <option value="AFG">Afghanisthan</option>
        ...
        <div>
          ...
          <select data-placeholder="Choose a Country..." class="chosen-select" tabindex="2">
            <option value="">Lib Select</option>
...
<br>
<hr>
  <p id="pToggle">Click Here to toggle (add/remove button/input-button display/remove) [also textarea value attribute change]
     </p>
     <p id="pTextArea">
  ...
  <p id="rToggle">Click Here to response(add/remove textnode) and redirection</p>
  <p id="rChange">
...
<p id="sToggle">Click Here to new tab open(google)</p>
<hr /> <hr />

<p id="s2Toggle">Click Here to new tab open(google) with 10 sec delay</p>
<hr /> <hr />

<p id="s3Toggle">Click Here to add/remove textnode and new tab open (google) with 5 sec delay</p>
<p id="sChange">
...
<script>
document.getElementById("pToggle").addEventListener("click",changePara);
document.getElementById("rToggle").addEventListener("click",changert);
document.getElementById("sToggle").addEventListener("click",changeSnewtab);
document.getElementById("sToggle").addEventListener("click",changeS2newtab);
document.getElementById("s3Toggle").addEventListener("click",changeS3newtab);

function changeSnewtab(){
  window.open('https://google.com', 'ResponseAsnewTab');
}

function changeS2newtab(){
  setTimeout(function(){
console.log("redirects in 10 seconds...");
window.open('https://google.com', 'ResponseAsnewTabDelay');
  },10000);
}

function changeS3newtab(){
  var node6 = document.createElement("INPUT");                 // Create a <li> node
//var textnode = document.createTextNode(e.target.value);
node6.id="HTMLinputbutton6";
node6.type="text";
node6.value="HTML6"


var textnode6 = document.createTextNode("HTML6");
textnode6.id="HTMLbutton6";         // Create a text node
//node.appendChild(textnode);

  if(document.getElementById("HTMLbutton6")){
 
  document.getElementById("HTMLbutton6").remove();
}else{

document.getElementById("sChange").appendChild(textnode6);
}

  setTimeout(function(){
console.log("redirects in 5 seconds...");
window.open('https://google.com', 'ResponseAndnewTab');
  },5000);
...
function changert(){
  ...
  var node4 = document.createElement("INPUT");                 // Create a <li> node
//var textnode = document.createTextNode(e.target.value);
node4.id="HTMLinputbutton4";
node4.type="text";
node4.value="HTML4"


var textnode4 = document.createTextNode("HTML4");
textnode4.id="HTMLbutton4";         // Create a text node
//node.appendChild(textnode);

  if(document.getElementById("HTMLbutton4")){
 
  document.getElementById("HTMLbutton4").remove();
}else{

document.getElementById("rChange").appendChild(textnode4);
}

  setTimeout(function(){
console.log("redirects in 3 seconds...");
window.location.href="https://devtracerresources.robotests.com/sample/public/index.php";
  },3000);
}
...
var textnode = document.createTextNode("HTML2");
node.id="HTMLbutton2";         // Create a text node
node.appendChild(textnode); 

var node2 = document.createElement("INPUT");                 // Create a <li> node
//var textnode = document.createTextNode(e.target.value);
node2.id="HTMLinputbutton2";
node2.type="text";
node2.value="HTML2"
...
if(document.getElementById("HTMLbutton2")){
  ...
  document.getElementById("HTMLinputbutton").style.display="block";
document.getElementById("pChange").appendChild(node);
document.getElementById("pChange").appendChild(node2);
document.getElementById("txtarea").value="AiTP";
}
